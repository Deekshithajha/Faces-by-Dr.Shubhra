...
export default async function Home() {
  ...
  return (
    <>
      <HeroSection
        title="Faces brings advanced skin and oculofacial care with an editorial calm"
        subtitle="Experience evidence-based dermatology, regenerative aesthetics, and expert eye-area treatments in a warm, premium clinical environment."
        ...
        imageAlt="Faces specialist portrait"
        imageFit="contain"
      />
